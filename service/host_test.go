...
func TestGetHostResponse(t *testing.T) {
	t.Run("With an errored response", func(t *testing.T) {
		...
		t.Run("The Host method should return an error", func(t *testing.T) {
			...
			require.Error(t, err)
			assert.Equal(t, "get host response: TestError", err.Error())
			assert.Nil(t, host)
		})
		...
		t.Run("The URL method should return an error", func(t *testing.T) {
			...
			require.Error(t, err)
			assert.Equal(t, "build host URL: TestError", err.Error())
			assert.Equal(t, "", url)
		})
		...
		t.Run("The PrivateURL should return an error", func(t *testing.T) {
			...
			require.Error(t, err)
			assert.Equal(t, "build host private URL: TestError", err.Error())
			assert.Equal(t, "", url)
		})
	})
